  ...
  <form id="myfm">
	...
	<div class="row">
	    <div style="text-align:center" class="col-md-12">
	    	...
	    	<button type="botton" class="btn btn-primary" onclick="top.Addtabs.closeTab('新增角色')">关闭</button>
	    </div>
	</div>
  </form>
</section>
		...
		$.ajax({
	        ...
	        success: function(result){
	            if (result.iserror){
	            	...
	            	top.toastr.error(result.message,'新增角色');
	            } else {
	            	top.$("#loading").fadeOut(100);
	            	top.toastr.success(result.message, '新增角色');
	            	top.Addtabs.closeAndReload('新增角色');
	            }
	        }
	    });
	}
