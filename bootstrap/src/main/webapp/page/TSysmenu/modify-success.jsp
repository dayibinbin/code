...
<section class="content">
  <form id="myfm">
    <input type="hidden" name="id" value="${tsysmenu.id}">
    <input type="hidden" name="createTime" value="<fmt:formatDate value="${tsysmenu.createTime}" pattern="yyyy-MM-dd HH:mm:ss"/>">
	    ...
	    <div class="row">
	      ...
	      <div class="col-md-6">
	        <div class="form-group">
              ...
              <input type="text" class="form-control validate[required]" value="${tsysmenu.name}" name="name" id="name">
            </div>
	        <!-- /.form-group -->
	        <div class="form-group">
              <label>菜单等级:</label>
	      ...
	      <div class="col-md-6">
	        <div class="form-group">
              ...
              <div class="input-group spinner" data-trigger="spinner">
	            <input readonly="readonly" type="text" class="form-control text-center" name="sequence" data-min="10" value="${tsysmenu.sequence}" data-step="10">
		    ...
		    <div class="row">
		      <div class="col-md-12">
		        <div class="form-group">
	              ...
	              <input type="text" class="form-control validate[required]" value="${tsysmenu.code}" name="code" id="code">
	            </div>
		        <div class="form-group">
	              <label for="navigateUrl">导航地址：</label>
	              <input type="text" class="form-control validate[required]" value="${tsysmenu.navigateUrl}" name="navigateUrl" id="navigateUrl">
		        </div>
		        <div class="form-group">
	              <label>父级菜单：</label>
	...
	<div class="row">
	    <div style="text-align:center" class="col-md-12">
	    	...
	    	<button type="botton" class="btn btn-primary" onclick="top.Addtabs.closeTab('修改菜单')">关闭</button>
	    </div>
	</div>
  </form>
</section>
...
function initSelect2() {
	var parentMenuId = ${tsysmenu.parentId};
    $.ajax({
        ...
        success: function (data) {
            ...
            $exampleMulti.val(parentMenuId).trigger("change");
        }
    });
}
//显示/隐藏二级菜单选项
		...
		$.ajax({
	        ...
	        success: function(result){
	            if (result.iserror){
	            	...
	            	top.toastr.error(result.message,'修改菜单');
	            } else {
	            	top.$("#loading").fadeOut(100);
	            	top.toastr.success(result.message, '修改菜单');
	            	top.Addtabs.closeAndReload('修改菜单');
	            }
	        }
	    });
	}
