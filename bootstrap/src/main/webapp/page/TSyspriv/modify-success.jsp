...
<section class="content">
  <form id="myfm">
  	<input type="hidden" name="menuId" value="${tsyspriv.menuId}">
    <input type="hidden" name="id" value="${tsyspriv.id}">
	<input type="hidden" name="createTime" value="<fmt:formatDate value="${tsyspriv.createTime}" pattern="yyyy-MM-dd HH:mm:ss"/>">
	    ...
	    <div class="row">
	      <div class="col-md-12">
              ...
              <div class="form-group">
                <label class="col-md-2">
                  <input value="btn btn-default" type="radio" name="iconCls" class="minimal">
	      ...
	      <div class="col-md-6">
	        <div class="form-group">
              ...
              <input type="text" class="form-control validate[required]" value="${tsyspriv.name}" name="name" id="name">
            </div>
	        <!-- /.form-group -->
	        <div class="form-group">
              <label for="code">权限代码：</label>
              <input type="text" class="form-control validate[required]" value="${tsyspriv.code}" name="code" id="code">
            </div>
	        <!-- /.form-group -->
	        <div class="form-group">
	      	  <label>状态:</label>
	      ...
	      <div class="col-md-6">
              ...
              <input type="text" class="form-control" value="${tsyspriv.menu.name}" id="menuName" disabled>
            </div>
	        <!-- /.form-group -->
	        <div class="form-group">
	      	  <label for="method">方法名称:</label>
	      	  <input type="text" class="form-control validate[required]" value="${tsyspriv.method}" name="method" id="method">
	        </div>
	        <!-- /.form-group -->
	        <div class="form-group">
	      	  <label>序列号:</label>
	      	  <div class="input-group spinner" data-trigger="spinner">
	            <input readonly="readonly" type="text" class="form-control text-center" value="${tsyspriv.sequence}" name="sequence" data-min="10" data-step="10">
	...
	<div class="row">
	    <div style="text-align:center" class="col-md-12">
	    	...
	    	<button type="botton" class="btn btn-primary" onclick="top.Addtabs.closeTab('修改权限')">关闭</button>
	    </div>
	</div>
  </form>
</section>
...
$(function(){
	...
	//初始化单选
	var iconCls = '${tsyspriv.iconCls}';
	$("input[name='iconCls'][value='"+iconCls+"']").iCheck('check');
});
//弹出图标选择框
function openIcon(){
		...
		$.ajax({
	        ...
	        success: function(result){
	            if (result.iserror){
	            	...
	            	top.toastr.error(result.message,'修改权限');
	            } else {
	            	top.$("#loading").fadeOut(100);
	            	top.toastr.success(result.message, '修改权限');
	            	top.Addtabs.closeAndReload('修改权限');
	            }
	        }
	    });
	}
